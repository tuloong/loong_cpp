...
#include <string>
#include "isPossible.cpp" // Include the isPossible function

using namespace std;

TEST(IsPossibleTest, Test1) {
    int n = 21;
    ...
    EXPECT_EQ(isPossible(n, edges), true);
}

TEST(IsPossibleTest, Test2) {
    int n = 3;
    vector<vector<int>> edges = {{1, 2}, {2, 3}};
    EXPECT_EQ(isPossible(n, edges), false);
}
